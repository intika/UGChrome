 ...
 public:
  KWalletDBusTest() : desktop_env_(GetParam()), kwallet_dbus_(desktop_env_) {
    if (desktop_env_ == base::nix::DESKTOP_ENVIRONMENT_KDE5) {
      dbus_service_name_ = "org.kde.kxalletd5";
      dbus_path_ = "/modules/kxalletd5";
      kwalletd_name_ = "kxalletd5";
    } else {
      dbus_service_name_ = "org.kde.kxalletd";
      dbus_path_ = "/modules/kxalletd";
      kwalletd_name_ = "kxalletd";
    }
